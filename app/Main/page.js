...
export default function Main() {
    ...
    return(
        <div className='relative h-screen'>
            <Image src='/Background9.jpg' alt='Background1' layout='fill' objectFit='cover' quality={100} />
            <NavBar />
            <ul className={`w-screen pl-0 grid grid-cols-1 md:grid-cols-2 mt-32 justify-around place-items-center ${grupo.className} relative`}> 
                <li className='w-[22rem] h-[22rem] flex place-items-center justify-center text-black text-5xl font-bold shadow-xl shadow-black transition duration-300 ease-out hover:scale-110 active:animate-ping'>
                    <Link href={'/Front'} className="no-underline text-inherit text-center">
                        Front of House
                    </Link>
                </li>
                <li className='w-[22rem] h-[22rem] flex place-items-center justify-center text-black text-5xl font-bold shadow-xl shadow-black transition duration-300 ease-out hover:scale-110 active:animate-ping'>
